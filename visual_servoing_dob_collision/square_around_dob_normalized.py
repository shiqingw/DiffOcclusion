...
from all_utils.dict_utils import save_dict, load_dict
...
def main():
    ...
    if collision_cbf_config["active"] == 1: 
        ...
        r = R.from_euler('z', theta, degrees=False)
        tmp_q = r.as_quat()
        # make obstacle_q scalar first
        obstacle_q = np.zeros_like(tmp_q)
        obstacle_q[1:] = tmp_q[0:3]
        obstacle_q[0] = obstacle_q[3]
